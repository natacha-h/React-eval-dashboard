...
const About = () => (
    <div id="about">
        ...
        <section id="about-text">
            ...
            <p> Je fait cette spécialisation en autonomie, puisque pendant ma formation j'ai préféré suivre la spé Symfony. Je suis donc capable de travailler aussi bien côté Front que côté back</p>
        </section>
    </div>
)
